...
```sh
python -m isovar.sid_data generate --snapshot SNAPSHOT --cache CACHE --acquired acquired
python -m isovar.sid_data pack --acquired acquired --output sid-reads.json.gz
python -m isovar.sid_data verify --bundle sid-reads.json.gz
```
